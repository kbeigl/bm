...
xref:../../../../bm-tracker/gps-osmand-tracker/src/asciidoc/gps-tracker-impl.adoc#_the_model[The Model for Tracker Development]  
defines a GPS message from a unique device. +
The REST `openapi.yml` file provides a bigger 
xref:../../../../bm-tracker/gps-osmand-tracker/src/asciidoc/gps-tracker-impl.adoc#_model_deviations[model for a complete GTS]. +
