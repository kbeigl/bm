...
/**
 * Exclusive slice integration test for RealTimeManager simulating login, initial data load, and
 * live updates. No RealTimeController involved!
 */
class RealTimeManagerIT extends BaseRealTimeTest {
  ...
  @Test
  void setupTest() {
    // 1. LOGIN (from REST API) into scenario
    ...
    // 2. INITIAL DATA LOAD (from REST API)
