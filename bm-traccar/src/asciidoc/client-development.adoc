// first level heading for consecutive sections of bm-traccar documentation
...
flowchart TD
    ...
    database-handling -- backdoor <br> validation --> traccar-server
....