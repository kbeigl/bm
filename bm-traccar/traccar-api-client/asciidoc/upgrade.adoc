...
The versioned input
xref:../../bm-traccar/traccar-openapitools-client/openapitools.adoc#_openapi_yaml_file[`openapi.yaml`] 
file is defined in the pom file. +
The project documentation also describes different 
xref:../../bm-traccar/traccar-openapitools-client/openapitools.adoc#_openapi_yaml_format[formats]
to be aware of.
