...
Goto projects 
xref:../bm-docs/ascii-doctor.adoc[AsciiDoctor implementation and usage]
...
https://camel.apache.org/components/docker-component.html[Docker :: Apache Camel]
...
Inspect Maven 4 for internal flattening ...
