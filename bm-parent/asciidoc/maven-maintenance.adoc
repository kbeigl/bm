...
goto
xref:../bm-traccar/traccar-openapitools-client/openapitools.adoc[`traccar-openapitools-client`]
...
goto
xref:../bm-traccar/traccar-api-client/traccar-api-client.adoc[`traccar-api-client`]
