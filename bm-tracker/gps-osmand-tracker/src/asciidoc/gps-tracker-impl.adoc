...
| File Name | Main Heading | # Headings | # Lines | 

| gps-tracker-impl.adoc | Implementation Path | 10 | 200 | | upgrade-traccar.adoc | Traccar Server Upgrade | 1 | 13 | | setup-development.adoc | setup development environment | 8 | 120 | | .asciidoctorconfig.adoc (various) | (config file, no headings) | 0 | ~20 | | OsmAndProtocolSpecification.adoc | OsmAnd Protocol Specification | 6 | 70 | | client-development.adoc | Traccar Client Development | 2 | 60 | | readme.adoc (various) | project documentation | 1 | 10 | | 
