= OsmAnd Live Tracking Protocol Specification
...
GET /track?id=phone1&lat=52.5200&lon=13.4050&timestamp=1678886400&speed=25.0&bearing=90.0&altitude=50.0&batt=85.0 HTTP/1.1 Host: https://www.google.com/search?q=my-gps-server.com
