...
[source,text]
-----------------
    [INFO] === blue marble simulations               === 1.1.24 
    [INFO] --- blue marble BOM                       --- 1.1.24 
    [INFO] ---- GPS Trackers                         --- 1.1.24 
    [INFO] ..... gps-osmand-tracker                      1.1.24 
    [INFO] ..... gps-osmand-player                       1.1.24 
    [INFO] ---- Traccar 6.14.2 Clients   *UPGRADE*   --- 1.1.24 
    [INFO] ..... traccar-openapitools-client      6.12.2 
    [INFO] ..... traccar-api-client               6.12.2-1.1.24 
    [INFO] ..... traccar-realtime-client          6.12.2-1.1.24 
    [INFO] --- blue marble docs aggregator   *NEW*   --- 1.1.24-beta
-----------------
...
// We are using the standard Maven release process, 
// which is based on the `mvn release:prepare` and `mvn release:perform` goals.
...
Technology Stack as of `v1.1.24`:
...
| Build | Maven | ≥ 4.0.0-rc-5

| App Framework | Spring Boot | 4.0.5

| Integration / Routing | Apache Camel | 4.20.0

| Unit Testing | JUnit 5 (and Camel testing) | 5.20.0

| Integration Test Infrastructure | Docker via Fabric8 plugin | 0.48.1

| GPS Server | Traccar | 6.14.2
...
=== Components used via Camel Endpoints

The table below lists the common Camel (`camel-version: 4.20.0`) endpoint URI patterns used across the projects, +
the Camel component artifact, and the underlying library version.

|===
| Camel Component| Endpoint String | Underlying Component

| `camel-file`
| `file:...` (e.g. `file:input?noop=true`) 
| Camel core
...
xref:bm-parent/maven-maintenance.adoc#_maven_wrapper[Maven Wrapper]   
...
xref:bm-parent/bm-parent.adoc[bm-parent details ...]
...
xref:./bm-tracker/bm-tracker.adoc[more about GPS and Tracking ...]
...
xref:./bm-tracker/gps-osmand-tracker/gps-osmand-tracker.adoc[goto gps-osmand-tracker project]
...
xref:./bm-tracker/gps-osmand-player/gps-osmand-player.adoc[goto gps-osmand-player project]
...
Please check the
xref:./bm-traccar/traccar-realtime-client/traccar-rt-quickstart.adoc[Quickstart]
